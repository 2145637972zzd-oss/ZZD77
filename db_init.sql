...
CREATE TABLE `canteen_info` (
  `canteen_id` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '食堂ID',
...
INSERT INTO `dish_info` (`window_id`, `dish_name`, `price`, `dish_type`) VALUES
(1, '红烧排骨', 12.00, '荤菜'), (1, '番茄炒蛋', 6.00, '半荤'), (1, '清炒时蔬', 3.00, '素菜'), (1, '白米饭', 1.00, '主食'),
(2, '牛肉面', 10.00, '粉面'), (2, '螺蛳粉', 12.00, '粉面'), (2, '桂林米粉', 9.00, '粉面'),
(3, '手抓饼', 6.00, '小吃'), (3, '奶茶', 8.00, '饮品'),
(4, '香煎鸡排', 10.00, '荤菜'), (4, '清蒸鱼', 15.00, '荤菜'), (4, '蒜蓉油麦菜', 4.00, '素菜'),
(5, '手抓饭', 13.00, '特色餐'), (5, '烤羊肉串', 15.00, '特色餐'),
(6, '韩式炸鸡', 18.00, '特色餐'), (6, '寿司拼盘', 20.00, '特色餐'),
(7, '商务套餐A', 15.00, '套餐'), (7, '商务套餐B', 18.00, '套餐');

INSERT INTO `user_info` (`user_id`, `name`, `gender`, `college`, `grade`, `major`, `balance`) VALUES
('2023001', '张三', 1, '计算机学院', '2023级', '软件工程', 200.00),
('2023002', '李四', 1, '计算机学院', '2023级', '计算机科学与技术', 150.00),
('2023003', '王五', 2, '经管学院', '2023级', '会计学', 300.00),
('2023004', '赵六', 2, '外国语学院', '2022级', '英语', 180.00),
('2023005', '孙七', 1, '机械学院', '2021级', '机械设计', 250.00);